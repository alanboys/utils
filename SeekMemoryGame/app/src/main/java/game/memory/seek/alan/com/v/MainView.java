package game.memory.seek.alan.com.v;
...
import game.memory.seek.alan.seekmemorygame.R;
...
public class MainView extends View {
    ...
    private final int numCellTypes = 17;
...
//                + iconSize, sYIcons + iconSize);
    ...
    private void drawHeader(Canvas canvas) {//左上角的文字
        // Drawing the header
        ...
        drawDrawable(canvas, backgroundRectangle, startingX, headerStartY, startingX
                + iconSize, headerStartY + iconSize);
        /**
         * 右上角提示图案
         */
        drawDrawable(canvas, cellRectangle[13],canvas.getWidth()/10, canvas.getWidth()/15, (canvas.getWidth()*4)/9, (canvas.getWidth()*3)/7);
        /**
         * 右上角提示图案 数字
         */
        canvas.drawText("8192", (canvas.getWidth()*4)/9, (canvas.getWidth()/15)+20, paint);
    }

    public void drawInstructions(Canvas canvas) {//底部的文字
    ...
    private void createEndGameStates(Canvas canvas, boolean win,
        ...
        if (win) {
            ...
            paint.setTextSize(gameOverTextSize);
            paint.setTextAlign(Paint.Align.CENTER);
            canvas.drawText(loseText, middleX, middleY - centerText(), paint);//游戏结束
        }
    }
...
//        drawCheatButton(canvas);//消除2的按键
    ...
    private void getLayout(int width, int height) {
        ...
        titleTextSize = textSize / 3;////数字上面的英文字大小
        bodyTextSize = (int) (textSize / 1.5);///数字大小
        instructionsTextSize = (int) (textSize / 1.8);
        headerTextSize = textSize * 0.6f;
    ...
    public MainView(Context context) {
        ...
        try {
            ...
            cellRectangle[0] = resources.getDrawable(R.drawable.cell_rectangle);//空白格
            cellRectangle[1] = resources.getDrawable(R.drawable.cell_rectangle_1);//设置数字
            cellRectangle[2] = resources.getDrawable(R.drawable.cell_rectangle_2);
            cellRectangle[3] = resources.getDrawable(R.drawable.cell_rectangle_3);
            cellRectangle[4] = resources.getDrawable(R.drawable.cell_rectangle_4);
            cellRectangle[5] = resources.getDrawable(R.drawable.cell_rectangle_5);
            cellRectangle[6] = resources.getDrawable(R.drawable.cell_rectangle_6);
            cellRectangle[7] = resources.getDrawable(R.drawable.cell_rectangle_7);
            cellRectangle[8] = resources.getDrawable(R.drawable.cell_rectangle_8);
            cellRectangle[9] = resources.getDrawable(R.drawable.cell_rectangle_9);
            cellRectangle[10] = resources.getDrawable(R.drawable.cell_rectangle_10);
            cellRectangle[11] = resources.getDrawable(R.drawable.cell_rectangle_11);
            cellRectangle[12] = resources.getDrawable(R.drawable.cell_rectangle_12);
            cellRectangle[13] = resources.getDrawable(R.drawable.cell_rectangle_13);
			cellRectangle[14] = resources.getDrawable(R.drawable.cell_rectangle_14);
			cellRectangle[15] = resources.getDrawable(R.drawable.cell_rectangle_15);
			cellRectangle[16] = resources.getDrawable(R.drawable.cell_rectangle_16);
