...
public class NumberKeyBoard extends View {
    ...
    public NumberKeyBoard(Context ctx) {
        super(ctx);
        this.ctx = ctx;
    }
    ...
    public View setup() {
        ...
        v = lif.inflate(R.layout.keyboard_layout, null);
        ...
        digitkeypad_edittext = (EditText) v.findViewById(R.id.password_ed);
